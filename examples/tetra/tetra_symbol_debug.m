...
fprintf('DMO bursts: %d confirmed / %d complete candidates, DSB=%d, DNB=%d, payload blocks=%d, SCH/S decoded=%d, timing assigned=%d\n', ...
    ...
    result.slots.schSDecodedCount, result.slots.timingAssignedCount);
