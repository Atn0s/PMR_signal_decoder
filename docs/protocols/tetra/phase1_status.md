...
[Current TETRA decode workflow](current_decode_workflow.md)

TETRA documentation index:

[TETRA documentation index](README.md)

Link-layer decode plan:

[TETRA DMO link-layer decode plan](link_layer_decode_plan.md)
