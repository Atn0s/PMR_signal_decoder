...
截至 2026-07-13，阶段 7a 已实现 LOCKED 健康迟滞、LOSS_PENDING、强证据恢复、
仍有能量时的 RECLASSIFYING 和 generation 隔离。UNKNOWN 指数退避、AMBIGUOUS
二次消歧和完整 SWITCHING/Epoch 分段仍待 7b，详见
[解码健康与重新分类实现记录](解码健康与重新分类实现记录.md)。
