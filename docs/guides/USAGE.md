...
[the 2.5 MHz 1x multi-carrier acceptance record](../records/validation/2.5MHz一倍速多载波并行前端修正与验收记录.md).
...
61.44 MS/s; see the [60 MHz wideband design](../architecture/60MHz宽带实时IQ信道化与并行解码设计.md) for the measured
...
- [Known-frequency multi-protocol recognition design](../architecture/已知频点多制式并行识别方案.md)
- [Real-time micro-batch five-protocol architecture](../architecture/实时微批处理五制式并行识别架构设计.md)
- [Offline baseband scanner integration record](../records/frontend/离线基带并行接入scanner实现记录.md)
- [Offline multi-Epoch recognition record](../records/recognition/离线多Epoch识别与上报实现记录.md)
- [Known-carrier DDC transition record](../records/frontend/已知载频DDC过渡模块实现记录.md)
- [Live spectrum selection frontend design](../architecture/实时频谱选频与循环回放解码前端设计.md)
- [2.5 MHz 1x multi-carrier acceptance record](../records/validation/2.5MHz一倍速多载波并行前端修正与验收记录.md)
