function symbols = recoverBurst(y, center, polarity, syncType)
%RECOVERBURST Recover a calibrated 132-symbol DMR data burst.
...
bestResid = inf;
symbols = [];
for phase = linspace(-8, 8, 65)
    start = center - (54 + 12) * cfg.samplesPerSymbol + phase;
