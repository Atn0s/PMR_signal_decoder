...
if any(strcmp(coordinator.state, {'CLASSIFYING', 'RECLASSIFYING'})) && ...
        isempty(coordinator.activeRace) && ~coordinator.deferProbeStart
...
initialPdus = struct([]);
if ~isempty(coordinator.lastRace) && ...
        isfield(coordinator.lastRace, 'winner') && ...
        ~isempty(coordinator.lastRace.winner)
    initialPdus = radio.getField( ...
        coordinator.lastRace.winner, 'pdus', struct([]));
end
